...
time go run . -dbname test10.db -dbpath /home/joris/Downloads/logfileparser_demodata/ -logfilefilter pruned -loglineregex '^(?P<RemoteIP>\S+) (?P<RemoteLogname>\S+) (?P<AuthUser>\S+) \[(?P<Timestamp>[^\]]+)\] "(?P<RequestMethod>\S+)(?:\s+(?P<RequestURI>[^\s"]*)[^"]*)?" (?P<StatusCode>\d+) (?P<BytesSent>\d)' -logpath /home/joris/Downloads/logfileparser_demodata/